...
export default function Deploy() {
  ...
  const deploy = async () => {
    ...
    try {
      const response = await fetch(API_URL + '/api/deploy/' + stats.sessionId, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({
          supabase_url: 'https://bmrdthnptzazsuoznhto.supabase.co',
          supabase_key: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJtcmR0aG5wdHphenN1b3puaHRvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDM1MDE5MzEsImV4cCI6MjA1OTA3NzkzMX0.4p4SsALw-wEpNQbg4hqpF2-GWjqE3RH9vWkf3VP9Y_w',
          db_password: 'nTelli@MiGkd{3#',
          use_sqlite: false
        })
      })
    ...
    >
      ...
      <motion.header variants={fadeInUp}>
        ...
        <p className="text-lg text-white/50 font-medium">
          Push your migrated schema to Supabase PostgreSQL
        </p>
      </motion.header>
      ...
      >
        {deployed ? (
          ...
          >
            ...
            <motion.a
              href="https://supabase.com/dashboard/project/bmrdthnptzazsuoznhto"
              target="_blank"
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-xl text-white/50">
                Your SQL schema will be deployed to Supabase PostgreSQL
              </p>
            </div>
            <motion.button
              onClick={deploy}
